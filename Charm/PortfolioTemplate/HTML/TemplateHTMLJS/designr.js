$(document).ready(function() {
	...
	Backstretch Images
	==============================================*/
	$.backstretch('/PortfolioTemplate/HTML/TemplateHTMLAssets/header-bg.jpg');

	$('body').append('<img class="preload-image" src="/PortfolioTemplate/HTML/TemplateHTMLAssets/contact-bg.jpg" style="display:none;"/>');
	...
	$('#about').waypoint(function(direction){
		...
		if (direction=='down'){
		    $.backstretch('/PortfolioTemplate/HTML/TemplateHTMLAssets/contact-bg.jpg');
		}else{
		    $.backstretch('/PortfolioTemplate/HTML/TemplateHTMLAssets/header-bg.jpg');
		}
	});
